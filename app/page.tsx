...
import type { Container } from "@tsparticles/engine"; // Import the Container type from @tsparticles/engine
...
export default function UltraStylishAnimatedPortfolio() {
  ...
  // Make the container parameter optional
  const particlesLoaded = useCallback(async (container?: Container | undefined) => {
    // Logic to execute after particles are loaded
  }, []);
